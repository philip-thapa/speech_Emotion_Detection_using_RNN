...
font = ('times', 16, 'bold')
title = Label(main, text='Clustering-Based Speech Emotion Recognition by Incorporating Learned Features and Deep BiLSTM')
...
ml = Button(main, text="Upload Audio", command=upload)
